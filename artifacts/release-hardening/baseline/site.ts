...
export const faq = [
  [
    pair(
      "هل Sparkle Auto برنامج حجوزات بس؟",
  ...
  [
    pair("لازم يكون عندي أكتر من فرع؟", "Do I need more than one branch?"),
    pair(
  ...
  [
    pair("العمال هيعرفوا يستخدموه؟", "Will the workers be able to use it?"),
    pair(
  ...
  [
    pair("هل السيستم بديل لمدير الفرع؟", "Does it replace the branch manager?"),
    pair(
  ...
  [
    pair(
      "أنا شغال بـWhatsApp ودفتر، ليه أغيّر؟",
  ...
  [
    pair("تجهيز السيستم بياخد وقت قد إيه؟", "How long does setup take?"),
    pair(
      ...
      "It depends on branches, services, data volume and team size. We start with an operations review and define a realistic setup plan instead of promising one fixed timeline for every car wash.",
    ),
  ],
  [
    pair(
      "إيه اللي هيحصل خلال تجربة الـ14 يوم؟",
      "What happens during the 14-day trial?",
    ),
    pair(
      "في مسودة العرض: بنحدد هدفًا واضحًا، ونجهز البيانات الأساسية، ونبدأ تشغيلًا حقيقيًا، ونعمل مراجعات أثناء التجربة. مدة التجربة وشروطها لسه محتاجة اعتماد قبل الإتاحة.",
      "In the proposed offer, we define a clear goal, prepare the essential data, begin real operations and review progress. The trial duration and terms still require confirmation before availability.",
    ),
  ],
  [
    pair(
      "لو محتاج ميزة معينة مش موجودة؟",
    ...
    pair(
      ...
      "We first review the problem the feature should solve. The answer may already exist in settings, sit on the development roadmap or require custom work. We explain the category before making a commitment.",
    ),
  ],
  [
    pair(
      "هل أقدر أتابع المغسلة وأنا بعيد؟",
  ...
  [
    pair("أعرف منين إنه مناسب لمغسلتي؟", "How do I know it fits my car wash?"),
    pair(
