...
export const comparison = [
  {
    label: pair("تكلفة البناء", "Build cost"),
    purchase: pair(
      "بناء منتج من البداية وتحديد كل متطلباته.",
      "Build a product from scratch and define its requirements.",
    ),
    sparkle: pair(
      "راجع الباقة المناسبة لحجم تشغيلك.",
      "Review a plan appropriate for your operation.",
    ),
  },
  {
    label: pair("البنية والتشغيل", "Infrastructure"),
    purchase: pair(
      "اختيار الاستضافة ومتابعة تشغيلها.",
      "Select hosting and manage its operation.",
    ),
    sparkle: pair(
      "وضّح مسؤوليات الاستضافة ضمن اتفاق الاشتراك.",
      "Clarify hosting responsibilities in the subscription agreement.",
    ),
  },
  {
    label: pair("الصيانة", "Maintenance"),
    purchase: pair(
      "ترتيب الصيانة ومعالجة الأعطال.",
      "Arrange maintenance and fault resolution.",
    ),
    sparkle: pair(
      "راجع نطاق الصيانة وشروط الاستجابة.",
      "Review maintenance coverage and response terms.",
    ),
  },
  {
    label: pair("التحديثات", "Product updates"),
    purchase: pair(
      "تحديد وتمويل مراحل التطوير الجديدة.",
      "Define and fund further development.",
    ),
    sparkle: pair(
      "ناقش المتاح وخارطة التطوير والعمل المخصص.",
      "Discuss available features, the roadmap and custom work.",
    ),
  },
  {
    label: pair("التجهيز والدعم", "Setup & support"),
    purchase: pair(
      "تجهيز البيانات والفريق وطريقة الدعم.",
      "Prepare data, team training and support arrangements.",
    ),
    sparkle: pair(
      "خطة تجهيز وتدريب حسب طريقة تشغيلك.",
      "An implementation and training plan around your workflow.",
    ),
  },
  {
    label: pair("التخصص", "Specialisation"),
    purchase: pair(
      "ترجمة تفاصيل المغسلة إلى متطلبات بناء.",
      "Translate car-wash workflows into build requirements.",
    ),
    sparkle: pair(
      "نظام مخصص لرحلة تشغيل مغاسل السيارات.",
      "A system focused on car-wash operations.",
    ),
  },
];
